			...
			<tr>
				...
				<td>
					...
					<table style="background-color: 89BCDD" align=center>
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">사용자 ID</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
								type="text" style="width: 240;" name="userId"></td>
						</tr>
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">비밀번호</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
								type="password" style="width: 240" name="password"></td>
						</tr>
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">비밀번호 확인</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
								type="password" style="width: 240" name="password2"></td>
						</tr>
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">이름</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
						...
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">이메일 주소</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
						...
						<tr height="40">
							<td width="150" align="center" bgcolor="89BCDD">전화번호</td>
							<td width="250" bgcolor="ffffff" style="padding-left: 10"><input
					...
					<table style="width: 100%">
						<tr>
							<td align="right"><input type="button" value="회원 가입"
								onClick="userCreate('<c:url value='/user/login/form'/>')">
								&nbsp; <input type="button" value="뒤로 가기"
								onClick="userList('<c:url value='/user/login/form' />')">
							</td>
						</tr>
					</table>
				</td>
