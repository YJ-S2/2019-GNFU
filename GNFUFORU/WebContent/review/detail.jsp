	...
	<table style="width: 70%" align=center>
		<tr>
			...
			<td>
				...
				<div align=center>
					<a
						href="<c:url value='/review/update/form'><c:param name='revId' value='<%=review.getRevId()%>'/><c:param name='getgynId' value='<%=review.getGynId()%>'/></c:url>">
						수정 </a> &nbsp;&nbsp; <a
			...
			<c:param name='getgynId' value='<%=review.getGynId()%>'/><c:param name='revId' value='<%=review.getRevId()%>'/><c:param name='userId' value='<%=review.getUserId()%>'/></c:url>">
						삭제</a>&nbsp;&nbsp; <a
						href="<c:url value='/review/list'><c:param name='getgynId' value='<%=review.getGynId()%>'/></c:url>">
						목록 </a>
				</div>
